            ...
            for (int i = first[point]; i != -1; i = edges[i].nxt) {
                ...
                for (int j = cost; j < cost + 1; j += 4) {
                    ...
                    if (dis[e.v] == -1) {
                        ...
                        priq.push(Point(e.v, dis[e.v] + 1.20 * calc_cost(e.v, target), 0));
                        if (e.v == target) {
                            int temp = target;
                            ...
                            while (temp != source) {
                                ...
                                map_node now_node = node2coord[temp]; now_node.theta = -2;
                                temp = ed.u;
                            }
